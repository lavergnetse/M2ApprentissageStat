...
```{r Libraries, cache=TRUE,include=F,message=FALSE, warning=FALSE}
library(readr)
library(dplyr)
library(tidyr)
library(ggplot2)
...
```{r import cleaned data, include=FALSE}
data <- read.csv("https://raw.githubusercontent.com/lavergnetse/Data/master/clean_data.csv", stringsAsFactors = TRUE)
``` 
...
```{r export cleaned data, eval = FALSE, include=FALSE}
# Export the data ready for algorithm
write.csv(data, "/Users/lemauffjulien/Desktop/Data/Data_Model", row.names = FALSE) 
```
